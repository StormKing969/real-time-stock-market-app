    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant={"ghost"}
          className={
            "flex items-center gap-3 text-gray-400 hover:text-yellow-500 cursor-pointer"
          }
        >
      ...
      <DropdownMenuContent className={"text-gray-400"}>
        ...
        <DropdownMenuItem
          ...
          className={
            "text-gray-100 text-base font-medium focus:bg-transparent focus:text-yellow-500 transition-colors cursor-pointer"
          }
        >
